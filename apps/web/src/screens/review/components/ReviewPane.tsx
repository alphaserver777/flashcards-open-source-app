...
function ReviewActiveCardPane(props: ReviewActiveCardPaneProps): ReactElement {
  ...
  const linkedLessonUrl = selectedCard.metadata.professorIt?.lmsLessonUrl ?? null;
  ...
  return (
    <>
      <div className="review-pane-head">
        <div className="review-pane-head-meta">
          {selectedCard.metadata.professorIt === undefined ? (
      ...
      {isAnswerVisible && (
        linkedLessonUrl !== null
        || (canManageSharedContent === false && workspaceId !== null)
      ) ? (
        <div className="review-meta">
          {linkedLessonUrl !== null ? (
            <a className="primary-btn" href={linkedLessonUrl} target="_blank" rel="noreferrer">
              Материалы
            </a>
          ) : null}
          {canManageSharedContent === false && workspaceId !== null ? (
