...
const esEsCatalog: TranslationCatalog = {
  ...
  workspaceExport: {
    title: "Exportar",
    subtitle: "Exporta o importa tarjetas activas para este espacio de trabajo.",
    workspaceUnavailable: "El espacio de trabajo no está disponible",
    formatsTitle: "Formatos disponibles",
    packageTitle: "Paquete nativo",
    packageDescription: "Exporta e importa flashcards.zip con tarjetas, etiquetas y multimedia referenciada.",
    packageExportSuccess: "La descarga de flashcards.zip ha comenzado.",
    packageExporting: "Exportando...",
    packageExportButton: "Exportar flashcards.zip",
    packageExportPreviewButton: "Previsualizar exportación",
    packageExportConfirmButton: "Descargar exportación previsualizada",
    ...
    previewImportTag: "Etiqueta de importación: {{tag}}",
    ...
    exportPreviewTagsTitle: "Etiquetas a quitar al exportar",
    exportPreviewRemoveTagLabel: "Quitar {{tag}} de la exportación ({{count}} tarjetas)",
    csvTitle: "CSV",
