...
export const zhHansCatalog = {
  ...
  workspaceExport: {
    title: "导出",
    subtitle: "为此工作区导出或导入活动卡片。",
    workspaceUnavailable: "工作区不可用",
    formatsTitle: "可用格式",
    packageTitle: "原生包",
    packageDescription: "导出和导入包含卡片、标签和引用媒体的 flashcards.zip。",
    packageExportSuccess: "已开始下载 flashcards.zip。",
    packageExporting: "正在导出...",
    packageExportButton: "导出 flashcards.zip",
    packageExportPreviewButton: "预览导出",
    packageExportConfirmButton: "下载已预览的导出",
    ...
    exportPreviewTagsTitle: "导出时移除标签",
    exportPreviewRemoveTagLabel: "从导出中移除 {{tag}}（{{count}} 张卡片）",
    csvTitle: "CSV",
