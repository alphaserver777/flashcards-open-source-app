const enCatalog = {
  ...
  workspaceExport: {
    title: "Export",
    subtitle: "Export or import active cards for this workspace.",
    workspaceUnavailable: "Workspace is unavailable",
    formatsTitle: "Available formats",
    packageTitle: "Native package",
    packageDescription: "Exports and imports flashcards.zip with cards, tags, and referenced media.",
    packageExportSuccess: "flashcards.zip download started.",
    packageExporting: "Exporting...",
    packageExportButton: "Export flashcards.zip",
    packageExportPreviewButton: "Preview export",
    packageExportConfirmButton: "Download previewed export",
    ...
    exportPreviewTagsTitle: "Export tag removal",
    exportPreviewRemoveTagLabel: "Remove {{tag}} from export ({{count}} cards)",
    csvTitle: "CSV",
