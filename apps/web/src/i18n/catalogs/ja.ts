...
export const jaCatalog = {
  ...
  workspaceExport: {
    title: "エクスポート",
    subtitle: "このワークスペースの有効なカードをエクスポートまたはインポートします。",
    workspaceUnavailable: "ワークスペースを利用できません",
    formatsTitle: "利用可能な形式",
    packageTitle: "ネイティブパッケージ",
    packageDescription: "カード、タグ、参照メディアを含む flashcards.zip をエクスポートおよびインポートします。",
    packageExportSuccess: "flashcards.zip のダウンロードを開始しました。",
    packageExporting: "エクスポートしています...",
    packageExportButton: "flashcards.zip をエクスポート",
    packageExportPreviewButton: "エクスポートをプレビュー",
    packageExportConfirmButton: "プレビュー済みエクスポートをダウンロード",
    ...
    exportPreviewTagsTitle: "エクスポート時に削除するタグ",
    exportPreviewRemoveTagLabel: "エクスポートから {{tag}} を削除 ({{count}}件のカード)",
    csvTitle: "CSV",
