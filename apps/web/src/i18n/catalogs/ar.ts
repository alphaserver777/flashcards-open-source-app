...
const arCatalog: TranslationCatalog = {
  ...
  workspaceExport: {
    title: "تصدير",
    subtitle: "صدّر أو استورد البطاقات النشطة لمساحة العمل هذه.",
    workspaceUnavailable: "مساحة العمل غير متاحة",
    formatsTitle: "التنسيقات المتاحة",
    packageTitle: "حزمة أصلية",
    packageDescription: "يصدّر ويستورد flashcards.zip مع البطاقات والوسوم والوسائط المشار إليها.",
    packageExportSuccess: "بدأ تنزيل flashcards.zip.",
    packageExporting: "جارٍ التصدير...",
    packageExportButton: "تصدير flashcards.zip",
    packageExportPreviewButton: "معاينة التصدير",
    packageExportConfirmButton: "تنزيل التصدير المعاين",
    ...
    previewImportTag: "وسم الاستيراد: {{tag}}",
    ...
    exportPreviewTagsTitle: "إزالة الوسوم عند التصدير",
    exportPreviewRemoveTagLabel: "إزالة {{tag}} من التصدير ({{count}} بطاقة)",
    csvTitle: "CSV",
