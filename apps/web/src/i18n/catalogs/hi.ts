...
const hiCatalog: TranslationCatalog = {
  ...
  workspaceExport: {
    title: "एक्सपोर्ट",
    subtitle: "इस वर्कस्पेस के सक्रिय कार्ड एक्सपोर्ट या इम्पोर्ट करें।",
    workspaceUnavailable: "वर्कस्पेस उपलब्ध नहीं है",
    formatsTitle: "उपलब्ध फ़ॉर्मैट",
    packageTitle: "नेटिव पैकेज",
    packageDescription: "कार्ड, टैग और संदर्भित मीडिया के साथ flashcards.zip एक्सपोर्ट और इम्पोर्ट करता है।",
    packageExportSuccess: "flashcards.zip डाउनलोड शुरू हो गया है।",
    packageExporting: "एक्सपोर्ट हो रहा है...",
    packageExportButton: "flashcards.zip एक्सपोर्ट करें",
    packageExportPreviewButton: "एक्सपोर्ट प्रीव्यू करें",
    packageExportConfirmButton: "प्रीव्यू किया गया एक्सपोर्ट डाउनलोड करें",
    ...
    previewImportTag: "इम्पोर्ट टैग: {{tag}}",
    ...
    exportPreviewTagsTitle: "एक्सपोर्ट में टैग हटाना",
    exportPreviewRemoveTagLabel: "एक्सपोर्ट से {{tag}} हटाएँ ({{count}} कार्ड)",
    csvTitle: "CSV",
