...
const hiCatalog: TranslationCatalog = {
  ...
  workspaceExport: {
    ...
    packageDescription: "सिर्फ cards.json वाले flashcards.zip को एक्सपोर्ट और इम्पोर्ट करता है। मीडिया फ़ाइलें अभी समर्थित नहीं हैं।",
    ...
    packageImportButton: "flashcards.zip इम्पोर्ट करें",
