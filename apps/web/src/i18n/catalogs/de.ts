...
const deCatalog: TranslationCatalog = {
  ...
  workspaceExport: {
    title: "Export",
    subtitle: "Exportiere oder importiere aktive Karten für diesen Arbeitsbereich.",
    workspaceUnavailable: "Arbeitsbereich ist nicht verfügbar",
    formatsTitle: "Verfügbare Formate",
    packageTitle: "Natives Paket",
    packageDescription: "Exportiert und importiert flashcards.zip mit Karten, Tags und referenzierten Medien.",
    packageExportSuccess: "Der Download von flashcards.zip wurde gestartet.",
    packageExporting: "Wird exportiert...",
    packageExportButton: "flashcards.zip exportieren",
    packageExportPreviewButton: "Exportvorschau anzeigen",
    packageExportConfirmButton: "Vorschau-Export herunterladen",
    ...
    previewImportTag: "Import-Tag: {{tag}}",
    ...
    exportPreviewTagsTitle: "Tags beim Export entfernen",
    exportPreviewRemoveTagLabel: "{{tag}} aus Export entfernen ({{count}} Karten)",
    csvTitle: "CSV",
