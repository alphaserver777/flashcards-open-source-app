...
const deCatalog: TranslationCatalog = {
  ...
  workspaceExport: {
    ...
    packageDescription: "Exportiert und importiert flashcards.zip nur mit cards.json. Mediendateien werden noch nicht unterstützt.",
    ...
    packageImportButton: "flashcards.zip importieren",
